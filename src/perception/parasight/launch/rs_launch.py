...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'rgb_camera.exposure',          'default': '20000', 'description': 'Set it to a value'},
                           ...
                           {'name': 'depth_module.exposure.1',      'default': '20000', 'description': 'Depth module first exposure value. Used for hdr_merge filter'},
                           {'name': 'depth_module.gain.1',          'default': '16', 'description': 'Depth module first gain value. Used for hdr_merge filter'},
                           {'name': 'depth_module.exposure.2',      'default': '20000', 'description': 'Depth module second exposure value. Used for hdr_merge filter'},
