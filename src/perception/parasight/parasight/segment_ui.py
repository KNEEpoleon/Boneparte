...
# Sreeharsha
base_ckpt_dir = "/home/harry/cmu/capstone/tekkneeca/src/segment-anything-2/checkpoints"
...
class SegmentAnythingUI:
    def __init__(self, size="small"):
        ...
        if size == 'small':
            sam2_checkpoint = (
                os.path.join(base_ckpt_dir, "sam2_hiera_small.pt")
            )
            model_cfg = "sam2_hiera_s.yaml"
        elif size == 'large':
            sam2_checkpoint = (
                os.path.join(base_ckpt_dir, "sam2_hiera_large.pt")
            )
        ...
        t0 = time.time()
        print(f"\n The sam2 checkpoint is: {sam2_checkpoint}")
