...
struct ImmersiveView: View {
    ...
    private func startARKitSession() async {
        ...
        // Load reference images from AR Resources group
    ...
    private func detectArucoMarker() async {
        ...
        do {
            // Monitor image anchor updates - this continues tracking even after first detection
